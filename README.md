...
[![Go Reference](https://pkg.go.dev/badge/github.com/anxiwuyanzu/openscraper-framework/spider-common-go/v4.svg)](https://pkg.go.dev/github.com/anxiwuyanzu/openscraper-framework/spider-common-go/v4)
...
```bash
go get -u github.com/anxiwuyanzu/openscraper-framework/spider-common-go/v4
```
